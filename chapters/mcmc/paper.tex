...
%  \caption{Our approach leverages a geographic reference database (b)
%  to estimate the geo-location (c) of a query image (a). (b) Top scoring
%samples (red arrows) are close to the actual location (green dot).}
