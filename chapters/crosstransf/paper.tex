...
\begin{figure}[t]
	\centering
	\includegraphics[width=\linewidth]{crosstransf/cartoon}
...
the training process. Our implementation is available at \todo{URL withheld 
pending publication}.
...
\begin{figure}
	\centering
	\includegraphics[width=.8\linewidth]{crosstransf/isprs/precisions}
...
\begin{figure}
	\centering
	\includegraphics[width=.7\linewidth]{crosstransf/orient/orient_err}
