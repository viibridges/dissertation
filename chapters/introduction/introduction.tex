...
%\begin{itemize}
  ...
  %\item \st{geometry for deep learning training}
  %\item \st{overhead images}
%\end{itemize}
...
In our work, we have shown that deep neural networks are powerful
...
\todo{cite}.
%
\todo{copy from scott} More recently, efforts have been made to
