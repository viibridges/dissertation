...
model the inherent uncertainties when the scene of the image is
ambiguous.  Furthermore, the outputs of deterministic system can not
be used by algorithms that take probabilistic inputs. To address these
