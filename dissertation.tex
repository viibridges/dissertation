...
algorithms. To address these limitations, we propose a probabilistic
...
geographic information is helpful for high-level feature extraction.
The primary contributions of our thesis include building a
probabilistic model for camera geo-calibration, and learning
high-level image representations with help of geographic information.
Our discoveries can provide researchers new insights for both camera
geo-calibration and DNN training.
}
